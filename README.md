...
This is a simplified computing experiment, and not all of the fly's neurons are trained - only the readout ones - that's why ther eis so little movement in fly in the gif.
